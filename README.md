...
Vote Wars was created with Node.js, using the [Clementine.js](https://github.com/johnstonbl01/clementinejs-fcc) boilerplate provided by [Free Code Camp](http://freecodecamp.com/).
The database on this app is on [MongoDB](http://www.mongodb.org/) and is hosted by [Heroku](https://www.heroku.com/).

More about Clementine.js:
