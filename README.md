...
Vote Wars is a application that allows you to create an account to make polls and share them with your friends. You can also sign in with Facebook for more convenience!

## Details

Vote Wars was created with Node.js, using the [Clementinejs](https://github.com/johnstonbl01/clementinejs-fcc) boilerplate provided by [Free Code Camp](http://freecodecamp.com/).
The database on this app is on  and is hosted by [Heroku](https://www.heroku.com/).
...
- **Free Code Camp (FCC)** (this version): A modified version of the standard boilerplate that is intended for use with the  curriculum.
